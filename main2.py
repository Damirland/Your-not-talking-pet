...
class Toy(pg.sprite.Sprite):
    def __init__(self):
        ...
        toys = random.choice(["images/toys/ball.png", "images/toys/blue bone.png", "images/toys/red bone.png"])

        self.image = load_image(toys, TOY_SIZE, TOY_SIZE)
...
class Button:
    def __init__(self, text, x, y, width=BUTTON_WIDTH, height=BUTTON_HEIGHT, text_font=font, func=None):
        ...
        self.sound = pg.mixer.Sound("button_sound.mp3")
...
class FoodMenu:
    def __init__(self, game):
        ...
        self.items = [Food("Мясо", 30, "images/food/meat.png", 10),
                      ...
                      Food("Кость", 3, "images/food/bone.png", 1)]
